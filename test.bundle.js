...
/***/ function(module, exports, __webpack_require__) {
	...
	function Game() {
	  ...
	  this.checkMoves = function () {
	    ...
	    directions.forEach((function (direction) {
	      ...
	      if (gridMovable(originalGrid, newGrid)) {
	        movesRemain = true;
	      };
	    }).bind(this));
	...
	Game.prototype.didBoardChange = function (grid) {
	  ...
	  for (var i = 0; i < 16; i++) {
	    if (currentGrid[i].num != previousGrid[i].num) {
	      changed = true;
	    };
	  };
	  return changed;
	...
	function gridMovable(originalGrid, newGrid) {
	  var moves = false;
	  var originalNums = _.flatten(originalGrid).map(function (tile) {
	    return tile.num;
	  });
	  var newNums = _.flatten(newGrid).map(function (tile) {
	    return tile.num;
	  });
	  for (var i = 0; i < originalGrid.length; i++) {
	    if (originalNums[i] != newNums[i]) {
	      moves = true;
	    };
	  };
	  return moves;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Board() {
	  ...
	  this.transposeGrid = function (direction) {
	    if (direction === 'up') {
	      this.grid = transposeUp(this.grid);
	    };
	    if (direction === 'down') {
	      this.grid = transposeDown(this.grid);
	    };
	    if (direction === 'right') {
	      this.grid = transposeRight(this.grid);
	    };
	    if (direction === 'left') {};
	    return this;
	  };
	  ...
	  this.normalizeGrid = function (direction) {
	    ...
	    if (direction === 'down') {
	      this.grid = normalizeDown(this.grid);
	    };
	    if (direction === 'right') {
	      this.grid = transposeRight(this.grid);
	    };
...
/***/ function(module, exports) {
	...
	var tileColors = { 0: "#FFFFFF", 2: "#e57373", 4: "#b71c1c", 8: "#ff8a65",
	  16: "#ff5722", 32: "#fff176", 64: "#ffc107", 128: "#81c784",
	  256: "#1b5e20", 512: "#81d4fa", 1024: "#01579b", 2048: "#4527a0" };

	var tilePokemon = { 0: "#FFF", 2: "images/magikarp-2.jpg", 4: "images/caterpie-4.jpg", 8: "images/pikachu-8.jpg",
	...
	var tileFace = { 0: "images/turing-tile.png", 2: "images/mike-2.gif", 4: "images/raissa-4.gif", 8: "images/horace-8.gif",
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = _.mixin({
	  isMatrix: __webpack_require__(7),
	  transpose: __webpack_require__(8)
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function baseIsMatrix(matrix) {
	  ...
	  return wrappedMatrix.map(getRowLength).uniq().value().length === 1 && isUndefined(wrappedMatrix.find(negate(isArray)));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Required files
	var isMatrix = __webpack_require__(7);
	var map = _.map;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		module.hot.accept("!!/Users/ericdowty/Rails/module-4/JavaScript-2048/node_modules/mocha-loader/node_modules/css-loader/index.js!/Users/ericdowty/Rails/module-4/JavaScript-2048/node_modules/mocha/mocha.css", function() {
			var newContent = require("!!/Users/ericdowty/Rails/module-4/JavaScript-2048/node_modules/mocha-loader/node_modules/css-loader/index.js!/Users/ericdowty/Rails/module-4/JavaScript-2048/node_modules/mocha/mocha.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	_exports.test = __webpack_require__(26);

	/*!
	 * type utility
	 */

	_exports.type = __webpack_require__(28);

	/*!
	 * message utility
	 */

	_exports.getMessage = __webpack_require__(30);

	/*!
	 * actual utility
	 */

	_exports.getActual = __webpack_require__(31);

	/*!
	 * Inspect util
	 */

	_exports.inspect = __webpack_require__(32);

	/*!
	 * Object Display util
	 */

	_exports.objDisplay = __webpack_require__(36);

	/*!
	 * Flag utility
	 */

	_exports.flag = __webpack_require__(27);

	/*!
	 * Flag transferring utility
	 */

	_exports.transferFlags = __webpack_require__(38);

	/*!
	 * Deep equal utility
	 */

	_exports.eql = __webpack_require__(39);

	/*!
	 * Deep path value
	 */

	_exports.getPathValue = __webpack_require__(47);

	/*!
	 * Deep path info
	 */

	_exports.getPathInfo = __webpack_require__(48);

	/*!
	 * Check if a property exists
	 */

	_exports.hasProperty = __webpack_require__(49);

	/*!
	 * Function name
	 */

	_exports.getName = __webpack_require__(33);

	/*!
	 * add Property
	 */

	_exports.addProperty = __webpack_require__(50);

	/*!
	 * add Method
	 */

	_exports.addMethod = __webpack_require__(51);

	/*!
	 * overwrite Property
	 */

	_exports.overwriteProperty = __webpack_require__(52);

	/*!
	 * overwrite Method
	 */

	_exports.overwriteMethod = __webpack_require__(53);

	/*!
	 * Add a chainable method
	 */

	_exports.addChainableMethod = __webpack_require__(54);

	/*!
	 * Overwrite chainable method
	 */

	_exports.overwriteChainableMethod = __webpack_require__(55);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var flag = __webpack_require__(27),
	    ...
	    objDisplay = __webpack_require__(36);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getName = __webpack_require__(33);
	var getProperties = __webpack_require__(34);
	var getEnumerableProperties = __webpack_require__(35);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getPathInfo = __webpack_require__(48);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var hasProperty = __webpack_require__(49);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var transferFlags = __webpack_require__(38);
	var flag = __webpack_require__(27);
	var config = __webpack_require__(37);
